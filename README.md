...
| 区分 | 内容 | 主な参照先 |
| --- | --- | --- |
| ScalableUIそのもの | AAOS/AOSP上のScalableUI、TaskPanel、StateManager、WindowManager連携の説明 | [docs/verification](docs/verification/README.md), [docs/architecture](docs/architecture/README.md) |
...
| Android17移植 | Android17 as-isを壊さずPoC差分を載せる開発フロー | [docs/android17](docs/android17/README.md) |
| 個人検証側/対象環境分担 | アプリレイヤー、RRO/XML、controller、task eventの担当境界 | [docs/architecture/aaos_app_layer_scalableui_scope_ja.md](docs/architecture/aaos_app_layer_scalableui_scope_ja.md) |
| workflow / reference | 実装手順、variant status、repo整理方針 | [docs/workflows](docs/workflows/README.md) |
| historical / experimental | 過去のdynamic workspace、editable home、widget系variant | [docs/historical](docs/historical/README.md) |
...
詳細は [docs/android17/aaos17_scalableui_development_flow_ja.md](docs/android17/aaos17_scalableui_development_flow_ja.md) を参照してください。

## AAOS15/Android16系の扱い

AAOS15 LTS3 / Android16 QPR2向けの既存patchや評価記録は残します。

ただし、それらはAndroid17の正ではありません。Android17ではScalableUI core、WMShell、TaskView周辺が更新されているため、Android15/16向けpatchをそのまま適用するのではなく、[docs/verification/aaos17_scalableui_source_verification_ja.md](docs/verification/aaos17_scalableui_source_verification_ja.md) と source 差分を確認して移植します。
...
これらの情報は削除せず、historical / experimental として扱います。本格適用設計やAndroid17移植の根拠にする場合は、必ず [docs/verification/aosp_source_verification_ja.md](docs/verification/aosp_source_verification_ja.md) と対象AAOS branchのsourceで再照合してください。
