...
- 12 個の HMI 案を product / lunch target で切り替える方法
...
2. [HMI Variant Suite](https://github.com/Nyma-fuk/scalableui-poc/blob/main/docs/hmi_variant_suite_ja.md)
3. [HMI Customization HowTo](HMI_Customization_HowTo_ja.md)
4. [XML and Panel Reference](XML_and_Panel_Reference_ja.md)
5. [Customization Recipes](Customization_Recipes_ja.md)
