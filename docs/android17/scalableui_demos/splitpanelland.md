# SplitPanelLandRRO ScalableUI Demo Analysis

## 位置づけ

複数 TaskPanel と grip / overlay DecorPanel を組み合わせ、split、drag、task switch を表現する構成。

- Source: `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO`
- 種別: `codelab`
- Build module: `SplitPanelLandRRO`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `app_panel` | `TaskPanel` | `@id/closed` | `@string/default_config` | `-` | `@+id/base`, `@+id/left_opened`, `@+id/closed`, `@+id/drag_left_opened`, `@+id/drag_frame_0`, `@+id/drag_frame_50`, `@+id/drag_frame_100` | `@+id/drag` | `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/app_panel.xml` |
| `decor_grip_bar_split_task` | `DecorPanel` | `@id/closed` | `@string/decor_split_grip_bar_provider` | `@xml/decor_grib_bar_split_controller` | `@+id/base`, `@+id/opened_left`, `@+id/opened_center`, `@+id/opened_right`, `@+id/closed`, `@+id/drag_frame_0`, `@+id/drag_frame_100` | `@+id/drag` | `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/decor_grip_bar_split_task.xml` |
| `decor_split_theme_overlay` | `DecorPanel` | `@id/closed` | `@string/decor_split_theme_overlay_panel_provider` | `@xml/decor_split_app_overlay_controller` | `@+id/base`, `@+id/closed`, `@+id/drag_frame_0`, `@+id/drag_frame_100` | `@+id/drag` | `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/decor_split_app_overlay.xml` |
| `decor_split_nav_overlay` | `DecorPanel` | `@id/closed` | `@string/decor_split_nav_overlay_panel_provider` | `@xml/decor_split_nav_overlay_controller` | `@+id/base`, `@+id/closed`, `@+id/drag_frame_0`, `@+id/drag_frame_100` | `@+id/drag` | `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/decor_split_nav_overlay.xml` |
| `map_panel` | `TaskPanel` | `@id/opened` | `@array/nav_components` | `-` | `@+id/base`, `@+id/opened`, `@+id/opened_split`, `@+id/closed`, `@+id/drag_frame_0`, `@+id/drag_frame_50`, `@+id/drag_frame_100` | - | `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/map_panel.xml` |
...
この demo では XML 上で 39 個の Transition が確認できる。主なものは以下。

| Panel | from | trigger | to |
| --- | --- | --- | --- |
| `app_panel` | `-` | `_System_TaskOpenEvent(panelId=app_panel)` | `@id/left_opened` |
| `app_panel` | `-` | `_System_OnHomeEvent` | `@id/closed` |
| `app_panel` | `-` | `_Drag_TaskSplitEvent_f0` | `@id/drag_frame_0` |
| `app_panel` | `-` | `_Drag_TaskSplitEvent_f50` | `@id/drag_frame_50` |
| `app_panel` | `-` | `_Drag_TaskSplitEvent_f100` | `@id/drag_frame_100` |
...
| `decor_split_theme_overlay` | `-` | `_System_TaskOpenEvent(panelId=app_panel)` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `_System_OnHomeEvent` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `_System_EnterSuwEvent` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `_System_ExitSuwEvent` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `close_app_grid` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `_User_DragEvent_split(direction=increase)` | `@id/drag` |
| `decor_split_theme_overlay` | `-` | `_User_DragEvent_split(direction=decrease)` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `_Drag_TaskSplitEvent_f0` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `_Drag_TaskSplitEvent_f50` | `@id/closed` |
| `decor_split_theme_overlay` | `-` | `_Drag_TaskSplitEvent_f100` | `@id/closed` |
...
| `decor_split_nav_overlay` | `-` | `_System_EnterSuwEvent` | `@id/closed` |
| `decor_split_nav_overlay` | `-` | `_System_ExitSuwEvent` | `@id/closed` |
| `decor_split_nav_overlay` | `-` | `close_app_grid` | `@id/closed` |
| `decor_split_nav_overlay` | `-` | `_User_DragEvent_split(direction=decrease)` | `@id/drag` |

他に 9 個の transition がある。詳細は各 XML を参照。
...
2. `m SplitPanelLandRRO` で RRO module を build する。複数 module がある場合は `SplitPanelLandRRO` を確認する。
...
- `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/app_panel.xml`
- `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/decor_grip_bar_split_task.xml`
- `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/decor_split_app_overlay.xml`
- `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/decor_split_nav_overlay.xml`
- `packages/apps/Car/References/scalable-ui/codelab/SplitPanelLandRRO/res/xml/map_panel.xml`
