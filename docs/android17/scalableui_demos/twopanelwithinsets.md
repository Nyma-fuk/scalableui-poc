# TwoPanelWithInsetsRRO ScalableUI Demo Analysis

## 位置づけ

map_panel を常時表示し、app_panel を task open で前面表示する 2 panel 構成。

- Source: `packages/apps/Car/References/scalable-ui/codelab/TwoPanelWithInsetsRRO`
- 種別: `codelab`
- Build module: `TwoPanelWithInsetsRRO`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `app_panel` | `TaskPanel` | `@id/closed` | `@string/default_config` | `-` | `@+id/opened`, `@+id/closed` | - | `packages/apps/Car/References/scalable-ui/codelab/TwoPanelWithInsetsRRO/res/xml/app_panel.xml` |
| `map_panel` | `TaskPanel` | `@id/opened` | `@array/nav_components` | `-` | `@+id/map_base`, `@+id/opened`, `@+id/opened_overlap`, `@+id/closed` | - | `packages/apps/Car/References/scalable-ui/codelab/TwoPanelWithInsetsRRO/res/xml/map_panel.xml` |
...
この demo では XML 上で 5 個の Transition が確認できる。主なものは以下。

| Panel | from | trigger | to |
| --- | --- | --- | --- |
| `app_panel` | `-` | `_System_TaskOpenEvent(panelId=app_panel)` | `@id/opened` |
| `app_panel` | `-` | `_System_OnHomeEvent` | `@id/closed` |
| `map_panel` | `-` | `_System_TaskOpenEvent(panelId=app_panel)` | `@id/opened_overlap` |
| `map_panel` | `-` | `_System_TaskOpenEvent(panelId=map_panel)` | `@id/opened` |
...
2. `m TwoPanelWithInsetsRRO` で RRO module を build する。複数 module がある場合は `TwoPanelWithInsetsRRO` を確認する。
...
- `packages/apps/Car/References/scalable-ui/codelab/TwoPanelWithInsetsRRO/res/xml/app_panel.xml`
- `packages/apps/Car/References/scalable-ui/codelab/TwoPanelWithInsetsRRO/res/xml/map_panel.xml`
