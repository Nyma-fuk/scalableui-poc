# TwoPanelRRO ScalableUI Demo Analysis

## 位置づけ

map_panel を常時表示し、app_panel を task open で前面表示する 2 panel 構成。

- Source: `packages/apps/Car/References/scalable-ui/codelab/TwoPanelRRO`
- 種別: `codelab`
- Build module: `TwoPanelRRO`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `app_panel` | `TaskPanel` | `@id/closed` | `@string/default_config` | `-` | `@+id/opened`, `@+id/closed` | - | `packages/apps/Car/References/scalable-ui/codelab/TwoPanelRRO/res/xml/app_panel.xml` |
| `map_panel` | `TaskPanel` | `@id/opened` | `@array/nav_components` | `-` | `@+id/map_base`, `@+id/opened`, `@+id/closed` | - | `packages/apps/Car/References/scalable-ui/codelab/TwoPanelRRO/res/xml/map_panel.xml` |
...
2. `m TwoPanelRRO` で RRO module を build する。複数 module がある場合は `TwoPanelRRO` を確認する。
...
- `packages/apps/Car/References/scalable-ui/codelab/TwoPanelRRO/res/xml/app_panel.xml`
- `packages/apps/Car/References/scalable-ui/codelab/TwoPanelRRO/res/xml/map_panel.xml`
