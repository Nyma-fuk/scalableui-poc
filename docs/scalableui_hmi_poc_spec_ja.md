...
現在は [overlays.xml](/home/y-fuk/work/android-automotiveos15-lts3/packages/services/Car/car_product/scalableui_poc/rro/CarSystemUIScalableUiPocRRO/res/xml/overlays.xml) で `drawable/grip_bar_background` を PoC 側の [poc_grip_bar_background.xml](/home/y-fuk/work/android-automotiveos15-lts3/packages/services/Car/car_product/scalableui_poc/rro/CarSystemUIScalableUiPocRRO/res/drawable/poc_grip_bar_background.xml) に差し替えている。見た目は dark rail + 明るい handle の少しモダンな grip を狙っている。

### runtime layout 補助

root PoC の width / height split は XML の transition だけに任せず、[ScalableUiPocRuntimeLayoutController.java](/home/y-fuk/work/android-automotiveos15-lts3/packages/apps/Car/SystemUI/src/com/android/systemui/car/wm/scalableui/ScalableUiPocRuntimeLayoutController.java) でも補助している。
