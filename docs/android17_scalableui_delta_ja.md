...
| 社内説明用の一言 | Android 17では、Panel定義が準備できてから動作を開始する安全装置が追加された |
...
| 我々への影響 | TaskPanel / TaskView / task routing を触るpatchは再設計が必要 |
...
| 社内説明用の一言 | TaskViewがどのroot taskを管理しているかを扱うための抽象が追加された |
