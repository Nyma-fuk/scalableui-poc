# Dynamic Workspace Variant

Historical / experimental variant.

`dynamic-workspace` was an earlier large ScalableUI HMI PoC. It avoids fixed XML slots and lets the runtime model create, remove, move, resize, and assign panels.
