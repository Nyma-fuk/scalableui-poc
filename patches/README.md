...
1. [docs/verification/aaos17_scalableui_source_verification_ja.md](../docs/verification/aaos17_scalableui_source_verification_ja.md) で source 事実を確認する。
2. [docs/android17/aaos17_scalableui_development_flow_ja.md](../docs/android17/aaos17_scalableui_development_flow_ja.md) の順に RRO / launcher / SystemUI 差分を小さく載せる。
